...
| ツール | 日付 | バージョン | 更新概要 |
|--------|------|-----------|----------|
| Chrome拡張機能版 | 2026-07-08 | ver. 1.19.2 | バッチ全クリア/最後の1件削除時にDOM参照ミスでエラーになり下書きが復活する不具合（[#221](https://github.com/tzhaya/jc-import-file-maker/issues/221)）、助成情報検索後にアコーディオンのラベルが更新されない不具合（[#224](https://github.com/tzhaya/jc-import-file-maker/issues/224)）、TSVエクスポートのファイル名にDOI由来のWindows禁止文字が残る不具合（[#226](https://github.com/tzhaya/jc-import-file-maker/issues/226)）を修正 |
