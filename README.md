...
| ツール | 日付 | バージョン | 更新概要 |
|--------|------|-----------|----------|
| Chrome拡張機能版 | 2026-03-22 | ver. 1.6.0 | ファイル情報のパス自動判定：data/以下のフォルダ選択でfile_pathを自動設定、画像ファイルはthumbnail既定（[#90](https://github.com/tzhaya/jc-import-file-maker/issues/90)） |
| インポート用TSV生成ツール | 2026-03-22 | — | ファイル情報のパス自動判定機能を追加（[#90](https://github.com/tzhaya/jc-import-file-maker/issues/90)） |
